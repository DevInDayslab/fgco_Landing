...
import { n as formatAdminDate, p as useSponsorships } from "./admin-api-Be6asTRJ.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/admin.sponsorships.index-Cdum4l7E.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageHeader, {
		...
		children: (rows) => rows.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DataTableEmpty, {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DataTableCell, { children: row.payment ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SponsorshipPaymentSummaryPanel, {
					payment: row.payment,
