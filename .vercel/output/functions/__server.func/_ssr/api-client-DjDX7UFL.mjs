import { j as requireAdminToken, w as logoutAdmin } from "./router-By49rm8R.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/api-client-DjDX7UFL.js
function getApiBaseUrl() {
	return "http://localhost:3000".trim().replace(/\/$/, "");
}
