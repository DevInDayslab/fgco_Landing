import { l as Route } from "./router-BsC5ZfFx.mjs";
import { v as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { a as require_jsx_runtime } from "../_libs/react+tanstack__react-query.mjs";
import { n as StatusBadge, t as PaymentBadge } from "./StatusBadge-CKMCsx9p.mjs";
import { f as useSponsorship, g as useUpdateSponsorship } from "./admin-api-Be6asTRJ.mjs";
...
import { t as SponsorshipPaymentSummaryPanel } from "./SponsorshipPaymentSummaryPanel-DEP5LBy1.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/admin.sponsorships._id-9sZQAryL.js
...
function SponsorshipDetailPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			data.payment ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DetailSection, {
				title: "Payment breakdown",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SponsorshipPaymentSummaryPanel, {
					payment: data.payment,
					paymentId: data.paymentId,
					paymentPaid: data.paymentPaid
				}), data.paymentRecord ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DetailGrid, {
					className: "mt-4",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DetailField, {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DetailTimestamp, {
							...
							value: data.paymentRecord.createdAt
						})
					]
				}) : null]
			}) : null,
