...
import { A as publicationOptions, D as nominatorRelationshipOptions, E as nominationCategories, F as signatureTiers, N as selectionTimeline, O as nomineeTypes, g as excellenceAwards, n as EVENT_LOCATION, t as AWARDS_TAGLINE, v as getNominationFeeBreakdown } from "./router-DmhiZPli.mjs";
import { n as useForm, r as require_react, t as u } from "../_libs/@hookform/resolvers+[...].mjs";
import { v as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { a as require_jsx_runtime } from "../_libs/react+tanstack__react-query.mjs";
import { F as Image, H as Film, O as MapPin, U as FileText, dt as ArrowLeft, f as Sparkles, g as Send, j as LoaderCircle, n as X, o as Upload, ut as ArrowRight } from "../_libs/lucide-react.mjs";
import { a as HeroAccent, o as HeroBackdrop } from "./PageLayout-pd1GZ2pX.mjs";
import { a as checkNomineeEmail, m as uploadNominationFile, o as isApiConfigured, s as postApplication } from "./api-client-_H6UHDTO.mjs";
...
import { t as openNominationRazorpayCheckout } from "./razorpay-checkout-CluWQGN0.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/nominate.index-C8dxmGuX.js
...
function NominationWizard() {
	...
	async function onSubmit(data) {
		const selfNomination = data.relationship === "Self (Nominee)" || data.nominatorEmail.trim().toLowerCase() === data.nomineeEmail.trim().toLowerCase();
		if (!isApiConfigured()) {
				...
				step === 5 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
							...
							children: "I confirm that the information provided is accurate and authentic. I grant FG MEDIA GROUP the rights to utilize the submitted details and media for publication and the HIT Awards consideration process."
						})]
...
function NominateIndex() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster$1, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
