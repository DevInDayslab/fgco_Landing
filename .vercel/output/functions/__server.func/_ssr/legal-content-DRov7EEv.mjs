import { H as FG_CONTACT, U as FG_OFFICE, j as paymentDetails } from "./router-D1tPpwBk.mjs";
import { v as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { a as require_jsx_runtime } from "../_libs/react+tanstack__react-query.mjs";
import { l as PageSection, p as SitePageHero } from "./PageLayout-pd1GZ2pX.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/legal-content-DRov7EEv.js
...
var nominationFee = `₹${paymentDetails.nominationFeeInr.toLocaleString("en-IN")}`;
			...
			subsections: [
				{
					...
					paragraphs: ["The HIT ViERA National Awards nomination portal allows individuals and organisations to submit applications for consideration by an independent jury. Submission of a nomination does not guarantee selection, shortlisting, or an award.", `A non-refundable nomination processing fee of ${nominationFee} plus applicable GST (${gstRate}) may be required to complete a nomination, unless otherwise stated on the portal at the time of submission.`]
				},
				{
			...
			subsections: [
				{
					...
					paragraphs: [`The nomination processing fee of ${nominationFee} plus GST (${gstRate}) is generally non-refundable once payment is successfully completed and the nomination is submitted for jury review.`, "This fee covers application processing, verification, platform costs, and administrative review."]
				},
				{
