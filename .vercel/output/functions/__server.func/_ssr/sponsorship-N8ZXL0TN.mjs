...
import { B as sponsorshipTiers, M as paymentDetails, O as mediaReachHighlights, V as siteButtonClass, c as JsonLd, h as awardsEventSchema } from "./router-BsC5ZfFx.mjs";
import { r as require_react } from "../_libs/@hookform/resolvers+[...].mjs";
import { v as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { a as require_jsx_runtime } from "../_libs/react+tanstack__react-query.mjs";
import { at as CircleCheck, dt as Building2, f as Star, it as CircleX, lt as Check, tt as CreditCard, x as RefreshCw } from "../_libs/lucide-react.mjs";
import { a as HeroAccent } from "./PageLayout-pd1GZ2pX.mjs";
import { t as BrandLogo } from "./BrandLogo-CgwpUbYQ.mjs";
import { o as isApiConfigured, p as postSponsorshipRegister } from "./api-client-povPFUIH.mjs";
...
import { n as openSponsorshipRazorpayCheckout } from "./razorpay-checkout-Bt1j4ehi.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/sponsorship-N8ZXL0TN.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function formatInr(amount) {
	return `₹ ${amount.toLocaleString("en-IN")}`;
}
function SponsorshipPaymentBreakdown({ plan }) {
	const rows = [
		{
			label: "Sponsorship package",
			value: formatInr(plan.packageInr)
		},
		{
		...
		},
		{
			...
			value: formatInr(plan.committedTotalInr),
			emphasis: true
		}
	];
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "border-b border-white/10 px-4 py-3 md:px-5",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-xs font-semibold tracking-[0.18em] text-amber-500/90 uppercase",
					children: "Payment breakdown"
				})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dl", {
				className: "divide-y divide-white/5 px-4 md:px-5",
				children: rows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center justify-between gap-4 py-3 text-sm",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", {
						className: row.emphasis ? "font-medium text-gray-200" : "text-gray-400",
						children: row.label
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("dd", {
						className: `shrink-0 tabular-nums ${row.emphasis ? "font-semibold text-foreground" : "font-medium text-gray-200"}`,
						children: row.value
					})]
				}, row.label))
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "border-t border-white/10 bg-amber-500/[0.04] px-4 py-4 md:px-5",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-start justify-between gap-4",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-sm font-semibold text-foreground",
							children: "Pay now via Razorpay"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-1 text-xs text-gray-500",
							children: "Incl. GST · max ₹5,00,000 online limit"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "mt-1 text-xs text-gray-500",
							children: [
								"Taxable ",
								formatInr(plan.razorpayBaseInr),
								" + GST ",
								formatInr(plan.razorpayGstInr)
							]
						})
					] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-xl font-bold tabular-nums text-amber-400",
						children: formatInr(plan.razorpayTotalInr)
					})]
				})
			}),
			plan.balanceTotalInr > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "border-t border-dashed border-white/10 bg-white/[0.02] px-4 py-4 md:px-5",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-start justify-between gap-4",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-sm font-medium text-gray-300",
						children: "Balance via bank transfer"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "mt-1 text-xs leading-relaxed text-gray-500",
						children: [
							"Taxable ",
							formatInr(plan.balanceBaseInr),
							" + GST ",
							formatInr(plan.balanceGstInr),
							" · due within ",
							paymentDetails.balanceDueDays,
							" days of the event"
						]
					})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "shrink-0 text-base font-semibold tabular-nums text-gray-300",
						children: formatInr(plan.balanceTotalInr)
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-3 rounded-lg border border-sky-500/20 bg-sky-500/5 px-3 py-2.5 text-xs leading-relaxed text-sky-200/90",
					children: "Our corporate relations team will contact you with bank transfer details and next steps after your Razorpay payment is confirmed."
				})]
			}) : null
		]
	});
...
var GST_RATE = Number.parseFloat(paymentDetails.gstRate) / 100;
/** Razorpay per-order limit — online sponsorship payment is capped at this amount incl. GST. */
var RAZORPAY_SPONSORSHIP_MAX_INR = 5e5;
function splitInrInclGst(totalInclGst) {
	const baseInr = Math.round(totalInclGst / (1 + GST_RATE));
	return {
		baseInr,
		gstInr: totalInclGst - baseInr,
		totalInr: totalInclGst
	};
}
function getSponsorshipPaymentPlan(tierId, packageInr) {
	...
	const balance = splitInrInclGst(committedTotalInr - RAZORPAY_SPONSORSHIP_MAX_INR);
	return {
		tierId,
		packageInr,
		packageGstInr,
...
function Sponsorship() {
	...
	const paymentPlan = tier && selectedTier ? getSponsorshipPaymentPlan(selectedTier, tier.amountInr) : null;
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormPanel, {
							...
							children: registrationReady && registration && tier && paymentPlan ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "space-y-6",
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											paymentPlan && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SponsorshipPaymentBreakdown, { plan: paymentPlan }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
										...
										children: [
											...
											" (",
											paymentDetails.gst,
											") · Razorpay limit ₹5,00,000 per transaction (incl. GST) · Balance payable by bank transfer within",
											" ",
											paymentDetails.balanceDueDays,
											" days of the event."
										]
