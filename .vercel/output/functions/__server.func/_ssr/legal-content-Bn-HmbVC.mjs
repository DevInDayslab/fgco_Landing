import { M as paymentDetails, U as FG_CONTACT, W as FG_OFFICE } from "./router-BsC5ZfFx.mjs";
import { v as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { a as require_jsx_runtime } from "../_libs/react+tanstack__react-query.mjs";
import { l as PageSection, p as SitePageHero } from "./PageLayout-pd1GZ2pX.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/legal-content-Bn-HmbVC.js
var import_jsx_runtime = require_jsx_runtime();
var LEGAL_ENTITY = "FG Media and Safety Technologies Pvt Ltd";
var LEGAL_BRAND = "FG Media Group";
var LEGAL_EFFECTIVE_DATE = "9 August 2026";
var LEGAL_JURISDICTION = "Bengaluru, Karnataka, India";
var LEGAL_GST = paymentDetails.gst;
var LEGAL_CONTACT = {
...
function LegalBody({ sections }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "legal-prose mx-auto max-w-3xl space-y-10 text-sm leading-relaxed text-muted-foreground",
		children: sections.map((section) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			...
			children: [
				...
				section.bullets && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
					...
					children: section.bullets.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: item }, item.slice(0, 48)))
				}),
				section.subsections?.map((subsection) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mt-5",
					children: [
						...
						subsection.paragraphs?.map((paragraph) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-2",
							children: paragraph
						}, paragraph.slice(0, 48))),
						subsection.bullets && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
							className: "mt-2 list-disc space-y-2 pl-5",
							children: subsection.bullets.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: item }, item.slice(0, 48)))
						})
					]
				}, subsection.title))
			]
...
function LegalPageLayout({ document }) {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SitePageHero, {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					className: "mx-auto mb-10 max-w-3xl text-xs text-muted-foreground",
					children: [
						"Last updated: ",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LegalBody, { sections: document.sections }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mx-auto mt-14 max-w-3xl rounded-2xl border border-border bg-card/50 p-6 text-sm text-muted-foreground",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "font-medium text-foreground",
						children: "Questions about these policies?"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "mt-2",
						children: [
							"Contact ",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
								...
								children: LEGAL_CONTACT.email
							}),
							", ",
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
								href: `mailto:${LEGAL_CONTACT.awardsEmail}`,
								className: "text-gold hover:underline",
								children: LEGAL_CONTACT.awardsEmail
							}),
							", or call ",
							LEGAL_CONTACT.phone,
							". Registered office: ",
...
var nominationFeeSelf = `₹${paymentDetails.nominationSelfFeeInr.toLocaleString("en-IN")}`;
var nominationFeeOther = `₹${paymentDetails.nominationOtherFeeInr.toLocaleString("en-IN")}`;
var gstRate = paymentDetails.gstRate;
var termsAndConditions = {
	...
	sections: [
		...
		},
		{
			...
			paragraphs: [`${LEGAL_BRAND} provides media, technology, awards, event management, sponsorship, and related digital services, including but not limited to:`],
			bullets: [
		...
		},
		{
			...
			paragraphs: ["You may use our website and portals only for lawful purposes and in accordance with these Terms. You agree not to:"],
			bullets: [
			...
			subsections: [
				{
					...
					paragraphs: ["The HIT ViERA National Awards nomination portal allows individuals and organisations to submit applications for consideration by an independent jury. Submission of a nomination does not guarantee selection, shortlisting, or an award.", `A non-refundable nomination processing fee may be required to complete a nomination: ${nominationFeeSelf} plus applicable GST (${gstRate}) for self-nominations, or ${nominationFeeOther} plus GST (${gstRate}) when nominating another person, unless otherwise stated on the portal at the time of submission.`]
				},
				{
				...
				},
				{
					...
					paragraphs: ["All evaluation, shortlisting, and award decisions are made at the sole discretion of the HIT ViERA jury and organising committee. Decisions are final and binding, subject only to applicable law.", "FG Media may verify credentials, conduct background checks, and request additional documentation before confirming finalists or winners."]
				},
				{
					title: "5.4 Publicity rights",
					paragraphs: ["By submitting a nomination, you grant FG Media a non-exclusive, royalty-free licence to use submitted names, biographies, images, and related materials for evaluation, publicity, publications, event programmes, digital media, and post-event recognition, unless otherwise agreed in writing."]
				}
			]
		},
		{
			...
			subsections: [
				{
					...
					paragraphs: ["Sponsorship opportunities for the HIT ViERA National Awards and related events are offered in designated tiers (including Super, Power, Golden, and Silver ViERA Sponsor categories) on a first-come, first-served basis, subject to availability and internal approval.", "A sponsorship request or online registration does not create a binding contract until confirmed in writing by FG Media and the required advance payment is received."]
				},
				{
				...
				},
				{
					...
					paragraphs: ["Sponsorship benefits, branding placements, media schedules, and deliverables are as described in the applicable sponsorship proposal, confirmation letter, or event kit. FG Media may modify non-material deliverables for operational, editorial, or legal reasons while preserving substantially equivalent value.", "Sponsors must submit brand assets, approvals, and content within agreed timelines. Delays caused by the sponsor may reduce or postpone deliverables without liability to FG Media."]
				}
			]
		},
		{
		...
		},
		{
			...
			paragraphs: [`All website content, logos, trademarks, publications, software, event materials, and proprietary technology (including InViGIL and ViERA) are owned by or licensed to ${LEGAL_ENTITY} and protected by applicable intellectual property laws.`, "No rights are granted to you except the limited right to access and use the website and services in accordance with these Terms."]
		},
		{
			id: "disclaimers",
			title: "9. Disclaimers",
		...
		},
		{
			...
			paragraphs: [`To the maximum extent permitted under Indian law, ${LEGAL_ENTITY} shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including loss of profits, goodwill, data, or business opportunity, arising from your use of our services.`, "Our aggregate liability for any claim relating to these Terms or our services shall not exceed the amount paid by you to FG Media for the specific service giving rise to the claim in the twelve (12) months preceding the event, except where liability cannot be limited by law."]
		},
		{
			id: "indemnity",
			title: "11. Indemnity",
			paragraphs: ["You agree to indemnify and hold harmless FG Media, its directors, officers, employees, partners, and affiliates from any claims, losses, damages, liabilities, and expenses (including reasonable legal fees) arising from your breach of these Terms, inaccurate submissions, infringement of third-party rights, or unlawful use of our services."]
		},
		{
			id: "law",
			title: "12. Governing Law & Disputes",
			paragraphs: [`These Terms are governed by the laws of India. Courts at ${LEGAL_JURISDICTION} shall have exclusive jurisdiction, subject to applicable consumer protection laws.`, "Before initiating formal proceedings, parties agree to attempt good-faith resolution by contacting us at the details below. Nothing in this clause limits your statutory rights as a consumer under applicable law."]
		},
		{
			id: "changes",
			title: "13. Changes to These Terms",
			paragraphs: ["We may update these Terms from time to time. The revised version will be posted on this page with an updated date. Material changes may also be communicated via email or website notice where appropriate. Continued use after changes constitutes acceptance."]
		}
	]
};
var privacyPolicy = {
	...
	sections: [
		{
			id: "overview",
			title: "1. Overview",
			paragraphs: [`${LEGAL_ENTITY} ("FG Media", "we", "us") respects your privacy and is committed to protecting personal data in accordance with applicable Indian law, including the Digital Personal Data Protection Act, 2023 ("DPDP Act"), and other relevant regulations.`, "This Privacy Policy explains what information we collect when you visit our website, submit nominations, register for sponsorship, contact us, make payments, or interact with our events and platforms."]
		},
		{
			id: "controller",
		...
		},
		{
			...
			paragraphs: ["Under the DPDP Act and applicable law, we process personal data based on one or more of the following grounds:"],
			bullets: [
		...
		},
		{
			...
			paragraphs: ["We do not sell personal data. We may share information only as necessary:"],
			bullets: [
		...
		},
		{
			...
			paragraphs: ["We retain personal data only for as long as necessary for the purposes described in this policy, including:"],
			bullets: [
		...
		},
		{
			id: "security",
			title: "8. Security",
			paragraphs: ["We implement administrative, technical, and organisational measures designed to protect personal data, including access controls, encryption in transit where supported, secure hosting practices, and staff confidentiality obligations. FG Media maintains ISO 27001 certified information security management practices.", "No method of transmission or storage is completely secure. You are responsible for safeguarding credentials and devices used to access our services."]
		},
		{
			id: "cookies",
			title: "9. Cookies & Analytics",
			paragraphs: ["We use cookies and similar technologies to enable core website functionality, remember preferences, analyse traffic, and improve performance. You may control cookies through your browser settings. Disabling certain cookies may affect site functionality.", "We may use third-party analytics or embedded services (such as maps or payment widgets) that collect information according to their own privacy policies."]
		},
		{
			id: "rights",
			title: "10. Your Rights",
			paragraphs: ["Subject to applicable law, including the DPDP Act, you may have the right to:"],
			bullets: [
		...
		},
		{
			...
			paragraphs: ["Our nomination and sponsorship services are not directed at individuals under 18. We do not knowingly collect personal data from children without appropriate parental or guardian consent. If you believe we have collected data from a minor improperly, please contact us for deletion."]
		},
		{
			id: "grievance",
			title: "12. Grievance & Contact",
			paragraphs: [`For privacy questions, data access requests, or complaints, contact our Grievance Officer at ${LEGAL_CONTACT.email} with the subject line "Privacy Request".`, "We aim to acknowledge requests within 7 business days and resolve them within timelines prescribed by applicable law."]
		},
		{
			id: "updates",
			title: "13. Changes to This Policy",
			paragraphs: ["We may update this Privacy Policy periodically. The latest version will always be available on this page with the updated date. Material changes may be communicated through the website or email where appropriate."]
		}
	]
};
var refundPolicy = {
	...
	sections: [
		{
			id: "scope",
			title: "1. Scope",
			paragraphs: [`This Refund Policy applies to payments made to ${LEGAL_ENTITY} through ${LEGAL_CONTACT.website}, the HIT ViERA Awards nomination portal, sponsorship registration flows, and other authorised FG Media payment channels.`, "This policy should be read together with our Terms & Conditions, Cancellation Policy, and Privacy Policy."]
		},
		{
			id: "general",
			...
			subsections: [
				{
					...
					paragraphs: [`The nomination processing fee (${nominationFeeSelf} for self-nominations or ${nominationFeeOther} when nominating another person, each plus GST at ${gstRate}) is generally non-refundable once payment is successfully completed and the nomination is submitted for jury review.`, "This fee covers application processing, verification, platform costs, and administrative review."]
				},
				{
		...
		},
		{
			...
			subsections: [{
				...
				paragraphs: [`Sponsorship slots are reserved upon receipt of the required advance (${paymentDetails.advancePercent} of total sponsorship value, unless otherwise stated in your confirmation). Advance amounts may be partially or fully non-refundable once production, media scheduling, or brand placement work has commenced.`]
			}, {
		...
		},
		{
			...
			paragraphs: ["If your account is debited but our system does not record a successful payment, contact us within 7 business days with transaction proof. We will verify with our payment gateway and either fulfil the service or initiate a refund.", "Duplicate transactions verified by our finance team will be refunded within 10–15 business days."]
		},
		{
			id: "processing",
		...
		},
		{
			...
			paragraphs: ["Initiating a chargeback without first contacting us may delay resolution and could affect your eligibility for future programmes. We cooperate with payment partners and provide transaction records to resolve legitimate disputes.", "Fraudulent chargeback claims may result in suspension from future nominations, sponsorships, or platform access."]
		},
		{
			id: "requests",
			title: "8. How to Request a Refund",
			paragraphs: ["Email refund requests to the appropriate address with your full name, organisation (if any), payment reference/transaction ID, date of payment, amount, and reason for the request:"],
			bullets: [
	...
	sections: [
		{
			id: "scope",
			title: "1. Scope",
			paragraphs: [`This Cancellation Policy describes how cancellations are handled for HIT ViERA National Awards nominations, sponsorship agreements, event registrations, and related services offered by ${LEGAL_ENTITY}.`, "Cancellation may affect refund eligibility as described in our Refund Policy."]
		},
		{
			id: "nominations",
			...
			subsections: [{
				...
				paragraphs: ["You may request withdrawal of a nomination by emailing us with your application reference number. Withdrawal requests must come from the submitting party or an authorised representative.", "Withdrawal does not automatically entitle you to a refund of the nomination fee once jury review or verification has commenced."]
			}, {
				title: "2.2 Cancellation by FG Media",
				bullets: ["We may cancel or reject nominations that violate our Terms, contain false information, or fall outside programme eligibility.", "We may remove submissions that pose legal, reputational, or security risks to the event or participants."]
			}]
		},
		{
			id: "sponsorship",
			...
			subsections: [
				{
					...
					paragraphs: ["Sponsors wishing to cancel must submit written notice to the email address on their sponsorship confirmation. Cancellation takes effect upon written acknowledgement by FG Media."],
					bullets: [
				...
				},
				{
					...
					paragraphs: ["FG Media may cancel a sponsorship allocation if payment is not received as agreed, brand assets violate guidelines, or the sponsor's conduct is inconsistent with event values or applicable law.", "If we cancel a confirmed sponsorship due to our inability to deliver the agreed tier, we will offer a comparable alternative, credit, or refund in accordance with the Refund Policy."]
				},
				{
					title: "3.3 Substitution and tier changes",
					paragraphs: ["Sponsors may request a change of tier or substitution of authorised representative subject to availability and written approval. Price differences and production timelines may apply."]
				}
			]
		},
		{
			...
			paragraphs: ["FG Media reserves the right to postpone, relocate, or modify the format of the HIT ViERA National Awards or related events due to operational, safety, regulatory, or force majeure circumstances."],
			bullets: [
		...
		},
		{
			...
			paragraphs: ["Neither party shall be liable for failure or delay in performance caused by events beyond reasonable control, including natural disasters, epidemics, government restrictions, strikes, utility failures, war, civil unrest, or internet/telecom outages.", "In such cases, FG Media will communicate alternative arrangements and applicable refund or credit options as soon as practicable."]
		},
		{
			id: "notice",
			title: "6. Notice Requirements",
			paragraphs: ["All cancellation requests must be sent in writing by email from the registered contact used during registration. Verbal or social media messages alone do not constitute valid cancellation notice.", "Include your name, organisation, reference/transaction ID, sponsorship tier or nomination category, and preferred resolution (withdrawal, postponement, or refund request)."]
		},
		{
			id: "contact",
...
//#endregion
export { termsAndConditions as a, refundPolicy as i, cancellationPolicy as n, privacyPolicy as r, LegalPageLayout as t };
