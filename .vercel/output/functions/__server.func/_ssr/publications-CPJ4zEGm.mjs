//#region node_modules/.nitro/vite/services/ssr/assets/publications-CPJ4zEGm.js
var publicationProfiles = [
	{
		id: "hit-news",
		code: "EN",
		accent: "text-en",
...
var MEDIA_WING_INTRO = "The Media Wing of FG Media Group is a global premium initiative — empowering communities through quality journalism in English, Telugu, and Kannada. From flagship national weeklies to digital-first storytelling on InViGIL, we reach households and decision-makers across India with honesty, depth, and cultural respect.";
//#endregion
export { printHubs as a, mediaStats as i, digitalExtensions as n, publicationProfiles as o, editorialPillars as r, MEDIA_WING_INTRO as t };
