...
import { I as sponsorshipTiers, L as siteButtonClass, T as mediaReachHighlights, k as paymentDetails } from "./router-rKTGDRj6.mjs";
...
import { a as getApiBaseUrl, f as postSponsorshipRegister } from "./api-client-C0fbUDSo.mjs";
...
import { n as openSponsorshipRazorpayCheckout } from "./razorpay-checkout-CzMgg8vO.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/sponsorship-nxUmeFEi.js
...
function Sponsorship() {
	...
	async function onInquirySubmit(e) {
		...
		try {
			if (!getApiBaseUrl()) throw new Error("API is not configured. Set VITE_API_BASE_URL.");
