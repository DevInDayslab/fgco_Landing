...
export const digitalAvatarRoles = [
  { role: "Professionals", text: "A digital professional representative." },
  { role: "Entrepreneurs", text: "A digital business intelligence partner." },
  { role: "Educators", text: "A personalized knowledge companion." },
  { role: "Creators", text: "A creative intelligence assistant." },
  { role: "Organizations", text: "An intelligent digital workforce layer." },
  { role: "Individuals", text: "A personal digital intelligence companion." },
];

export const vieraPrinciples = [
  {
    title: "Protect",
...
export const vieraComparisonRows = [
  ["Core approach", "Personalized Virtual Intelligence & digital replica", "Generic command-response AI"],
  ["Representation", "Intelligent digital avatar of the user", "Detached assistant"],
  ["Learning", "Evolves with user training and goals", "Limited personalization"],
  ["Platform", "InViGIL + ViERA integrated ecosystem", "Standalone tools"],
  ["Purpose", "Protect, empower, and guide the individual", "Task automation only"],
];
