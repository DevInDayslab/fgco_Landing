...
const nominationFeeSelf = `₹${paymentDetails.nominationSelfFeeInr.toLocaleString("en-IN")}`;
const nominationFeeOther = `₹${paymentDetails.nominationOtherFeeInr.toLocaleString("en-IN")}`;
